...
rospy.init_node('tb0_node', anonymous=True) 
...
robot = moveit_commander.RobotCommander("/tb3_0/robot_description","tb3_0")
#scene = moveit_commander.PlanningSceneInterface("/tb3_0/robot_description","tb3_0")
group_arm = "arm"
group_name = "gripper"
group = moveit_commander.MoveGroupCommander(group_name,"/tb3_0/robot_description","tb3_0")
grouparm = moveit_commander.MoveGroupCommander(group_arm,"/tb3_0/robot_description","tb3_0")
p = PickPlaceInterface(group_arm, group_name)
...
def Dorotation():
        ...
        cmd_vel = rospy.Publisher('tb3_0/cmd_vel', Twist, queue_size=10)
...
def find(x,y):
    ...
    #rospy.init_node('moveit_routine_fix', anonymous=True)
    img_sub = rospy.Subscriber("/coordinates00",Point, drive_callback, (x, y))
    rospy.spin()
