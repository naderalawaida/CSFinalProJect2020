...
rospy.init_node('tb1_node', anonymous=True) 
...
robot = moveit_commander.RobotCommander("/tb3_1/robot_description", "tb3_1")
#scene = moveit_commander.PlanningSceneInterface(ns="tb3_1")
group_arm = "arm"
group_name = "gripper"
group = moveit_commander.MoveGroupCommander(group_name,  "/tb3_1/robot_description", "tb3_1")
grouparm = moveit_commander.MoveGroupCommander(group_arm,  "/tb3_1/robot_description", "tb3_1")
...
def Dorotation():
        ...
        cmd_vel = rospy.Publisher('tb3_1/cmd_vel', Twist, queue_size=10)
...
def find(x,y):
    ...
    #rospy.init_node('moveit_routine_fix', anonymous=True)
    img_sub = rospy.Subscriber("/coordinates01",Point, drive_callback, (x, y))
    rospy.spin()
