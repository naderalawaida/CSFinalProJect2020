...
rospy.init_node('tb2_node', anonymous=True) 
...
robot = moveit_commander.RobotCommander("/tb3_2/robot_description", "tb3_2")
#scene = moveit_commander.PlanningSceneInterface(ns="tb3_4")
group_arm = "arm"
group_name = "gripper"
group = moveit_commander.MoveGroupCommander(group_name,  "/tb3_2/robot_description", "tb3_2")
grouparm = moveit_commander.MoveGroupCommander(group_arm,  "/tb3_2/robot_description", "tb3_2")
...
def Dorotation():
        ...
        cmd_vel = rospy.Publisher('tb3_2/cmd_vel', Twist, queue_size=10)
...
def find(x,y):
    ...
    #rospy.init_node('moveit_routine_fix', anonymous=True)
    img_sub = rospy.Subscriber("/coordinates02",Point, drive_callback, (x, y))
    rospy.spin()
