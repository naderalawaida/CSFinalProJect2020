...
rospy.init_node('tb3_node', anonymous=True) 
...
robot = moveit_commander.RobotCommander("/tb3_3/robot_description", "tb3_3")
#scene = moveit_commander.PlanningSceneInterface("/tb3_3/robot_description", "tb3_3")
group_arm = "arm"
group_name = "gripper"
group = moveit_commander.MoveGroupCommander(group_name,  "/tb3_3/robot_description", "tb3_3")
grouparm = moveit_commander.MoveGroupCommander(group_arm,  "/tb3_3/robot_description", "tb3_3")
...
def Dorotation():
        ...
        cmd_vel = rospy.Publisher('tb3_3/cmd_vel', Twist, queue_size=10)
...
def goto(pos, quat):
    ...
    move_base = actionlib.SimpleActionClient("/tb3_3/move_base", MoveBaseAction)
...
def drive_callback(data, args):
    ...
    pub_vel = rospy.Publisher('tb3_3/cmd_vel', Twist, queue_size=5)
...
def find(x,y):
    ...
    #rospy.init_node('moveit_routine_fix', anonymous=True)
    img_sub = rospy.Subscriber("/coordinates03",Point, drive_callback, (x, y))
    rospy.spin()
