...
if __name__ == '__main__':
    ...
    # Initialize the node
    rospy.init_node('color_tracker02', anonymous=True)

    # Subscribe to raspicam_node and receive the image
    img_sub = rospy.Subscriber("tb3_2/camera/rgb/image_raw", Image, image_callback)
    bridge = CvBridge()
    
    # Publish x-y coordinates over ball_location topic
    pub_point = rospy.Publisher('/coordinates02', Point, queue_size=5)
    rospy.spin()